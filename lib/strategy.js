...
Strategy.prototype.authenticate = function(req, options) {
  ...
  if (req.query && req.query.code) {
    ...
    this._getOAuthJwtAccessToken(code, params,
...
Strategy.prototype.refreshAccessToken = function(refreshToken, callback) {
  return this._getOAuthJwtAccessToken(refreshToken, { grant_type: 'refresh_token' }, callback);
};

Strategy.prototype._getOAuthJwtAccessToken = function(code, params, callback) {
  ...
  this._oauth2._request("POST", this._getAccessTokenUrl(), post_headers, post_data, null, function(error, data, response) {
